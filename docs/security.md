...
Sensitive operations have dedicated scopes. Examples include Docker secret reveal, database credential reveal, certificate export, node console access, container file access, and audit log access.
