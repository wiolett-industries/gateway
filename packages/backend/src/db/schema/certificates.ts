import { pgTable, uuid, varchar, text, timestamp, boolean, pgEnum, index, uniqueIndex, jsonb } from 'drizzle-orm/pg-core';
...
export const certificates = pgTable('certificates', {
  ...
  caId: uuid('ca_id').notNull().references(() => certificateAuthorities.id, { onDelete: 'restrict' }),
