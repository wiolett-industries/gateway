        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/proxy-hosts/new" element={scoped("proxy:manage", <ProxyHostDetail />)} />
              ...
              <Route path="/nginx-templates/new" element={scoped("proxy:manage", <NginxTemplateEdit />)} />
              <Route path="/nginx-templates/:id" element={scoped("proxy:read", <NginxTemplateEdit />)} />
              <Route path="/ssl-certificates" element={scoped("ssl:read", <SSLCertificates />)} />
              <Route path="/domains" element={scoped("proxy:read", <Domains />)} />
              <Route path="/nginx" element={scoped("proxy:manage", <NginxManagement />)} />
              ...
              <Route path="/certificates/:id" element={scoped("cert:read", <CertificateDetail />)} />
