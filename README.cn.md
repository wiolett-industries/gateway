...
只有当拥有者已经具备所需 scopes 时才可以。Sensitive OAuth scopes 在 consent 时需要显式 opt-in，API/OAuth tokens 不能超过用户当前的 effective permissions。参见 [SCOPES.md](SCOPES.md)。
</details>
...
| Tier | 适用对象 | Key | 当前行为 |
|------|----------|-----|----------|
| ![Community](docs/assets/license/wiolett-gw-community-24.png) Community | Personal use, noncommercial use, and permitted source-license use under [LICENSE.md](LICENSE.md). | 不需要。 | Full product access today. |
